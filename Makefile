...
local-run:
	ROCKET_SECRET_TOKEN=$(ROCKET_DUMMY_TOKEN) NOTION_URL=$(NOTION_URL) ROCKET_API_TOKEN=$(ROCKET_API_TOKEN) ROCKET_API_ID=$(ROCKET_API_ID) PORT=$(PORT) NOTION_API_KEY=$(NOTION_API_KEY) crystal run src/app.cr
